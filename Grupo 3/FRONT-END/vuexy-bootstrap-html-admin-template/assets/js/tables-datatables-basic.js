...
$(function () {
  ...
  if (dt_basic_table.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $status = {
              1: { title: 'Administrador', class: 'bg-label-primary' },
              2: { title: 'Asistente', class: ' bg-label-success' },
              3: { title: 'Inspector', class: ' bg-label-danger' },
              4: { title: 'Jefe de Area', class: ' bg-label-warning' }
            };
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Lista de Usuarios</h5>');
  }
