(function($) {
    ...
    /* Close Public Ads for CorTrip*/
    $('.ads-cortrip button').on('click', function(event) {
        $('.ads-cortrip').addClass("mfp-hide");
    });
    ...
    var cardSlider = new Swiper('.restaurant-slider', {
		autoplay: {
            delay: 1,
            disableOnInteraction: false,
        },
    ...
    function lformSuccess() {
        $("#callMeForm")[0].reset();
        lsubmitMSG(true, "¡Solicitud enviada! Verifique su correo");
    ...
    $("#contactForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            cformError();
            csubmitMSG(false, "¡Porfavor llenar el formulario!");
        } else {
            // everything looks good!
            event.preventDefault();
            csubmitForm();
    ...
    $("#privacyForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            pformError();
            psubmitMSG(false, "¡Porfavor llenar el formulario!");
        } else {
            // everything looks good!
            event.preventDefault();
            psubmitForm();
